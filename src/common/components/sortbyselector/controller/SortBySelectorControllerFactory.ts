...
export default class SortBySelectorControllerFactory extends NamespacedControllerFactory<SortBySelectorPageStateNamespace> {
  createController = () => ({
    ...
    changeSelectedSortBySortDirectionForSelectedChart: (
      ...
      this.dispatchAction(
        new ChangeSelectedSortByDirectionForSelectedChartAction(
          this.stateNamespace,
          selectedSortBy,
          sortDirection
        )
    ...
    changeSelectedSortByDataScopeTypeForSelectedChart: (
      ...
      this.dispatchAction(
        new ChangeSelectedSortByDataScopeTypeForSelectedChartAction(
          this.stateNamespace,
          selectedSortBy,
          dataScopeType
        )
    ...
    removeSelectedSortByFromSelectedChart: (selectedSortBy: SelectedSortBy) => {
      this.dispatchAction(
        new RemoveSelectedSortByFromSelectedChartAction(this.stateNamespace, selectedSortBy)
      );
